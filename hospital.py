...
def generate_graph():
    con = mysql.connector.connect(host="localhost", username="root", password="Viswa@123", database="mydata")
...
# Delete
def delete():
    con = mysql.connector.connect(host="localhost", user="root", password="Viswa@123", database="mydata")
    my_cursor = con.cursor()
